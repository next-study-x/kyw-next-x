            ...
            <div className="inline-flex h-[50px] p-3 items-center gap-5">
              {segment === "home" ? (
                <>
                  ...
                  <div className="text-[20px] font-bold text-white">Home</div>
                </>
              ) : (
                <>
                  <svg
            ...
            <div className="inline-flex h-[50px] p-3 items-center gap-5">
              {segment && ["search", "explore"].includes(segment) ? (
                ...
                <>
                  ...
                  <div className="text-white text-[20px]">Explore</div>
                </>
              )}
            </div>
          </Link>
            ...
            <div className="inline-flex h-[50px] p-3 items-center gap-5">
              {segment === "messages" ? (
                ...
                <>
                  ...
                  <div className="text-white text-[20px]">Messages</div>
                </>
              )}
            </div>
          </Link>
              ...
              <div className="inline-flex h-[50px] p-3 items-center gap-5">
                {segment === me.id ? (
                  ...
                  <>
                    ...
                    <div className="text-white text-[20px]">Profile</div>
                  </>
                )}
              </div>
            </Link>
