  ...
  return (
    <div className="flex-1">
      <Link className="inline-block mb-2" href={"/home"}>
        <div className="w-[50px] h-[50px] rounded-full flex items-center justify-center hover:bg-gray-100">
          <Image width={30} height={30} src={XLogo} alt="x.logo" />
        </div>
      </Link>
      <ul className="flex flex-col gap-2">
        <li>
          <Link href="/home">
            <div className="inline-flex h-[50px] p-3 items-center gap-5">
              {segment === "home" ? (
                <>
                  <svg
                    fill="white"
                  ...
                  <div className="text-[20px] font-bold text-white hidden lg:inline">
                    Home
                  </div>
                </>
              ) : (
                <>
                  ...
                  <div className="text-[20px] text-white hidden lg:inline">
                    Home
                  </div>
                </>
              )}
            ...
            <div className="inline-flex h-[50px] p-3 items-center gap-5">
              {segment && ["search", "explore"].includes(segment) ? (
                <>
                  ...
                  <div className="font-bold text-[20px] text-white hidden lg:inline">
                    Explore
                  </div>
                </>
              ) : (
                <>
                  ...
                  <div className="text-white text-[20px] hidden lg:inline">
                    Explore
                  </div>
                </>
              )}
      ...
      <Link
        className="my-4 w-[50px] h-[50px] flex items-center justify-center lg:h-[52px] bg-blue-500 text-white lg:w-[234px] font-bold text-[17px] rounded-[26px] hover:bg-[#1a8cd8]"
        href={"/compose/post"}
      >
        ...
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          className="w-[24px] h-[24px] lg:hidden r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-1472mwg r-lrsllp"
          fill="white"
        >
          <g>
